...
import { ArrowRight, CheckCircle, Clock, Lock, Trophy, BookOpen, Star } from 'lucide-react';
    ...
    <div style={{ background: 'var(--color-background)' }}>
      ...
      {actCourses.length > 0 && (
        <section className="section-padding" style={{ background: 'var(--color-background)' }}>
          <div className="container-app">
            <SectionHeader eyebrow="ACT Courses" title="Enroll in an ACT Course" subtitle="Structured courses covering all four ACT sections with expert guidance." />

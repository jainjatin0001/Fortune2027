      ...
      <div className="p-5 border-b shrink-0" style={{ borderColor: 'var(--sidebar-border)' }}>
        <Link href="/admin" className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col items-start justify-center gap-[2px]">
            <span className="text-[15px] font-bold leading-none" style={{ color: '#17356D' }}>{APP_NAME}</span>
            <div className="flex items-center w-full gap-1">
              <div className="h-px flex-1" style={{ background: '#C7A14B' }} />
              <span style={{ color: '#C7A14B', fontSize: '7px', lineHeight: 1 }}>✦</span>
              <div className="h-px flex-1" style={{ background: '#C7A14B' }} />
            </div>
            <span className="text-[9px] font-medium tracking-widest" style={{ color: '#C7A14B' }}>Pursuit of Excellence</span>
          </div>
        </Link>
      </div>
